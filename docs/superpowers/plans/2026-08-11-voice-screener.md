...
1. После `prepareAudio` отправить готовый файл на пакетное распознавание с запросом
   пословных таймингов и уверенности. Кандидаты: AssemblyAI async (~$0.21/час, лучший
   опубликованный результат на акцентированном английском), Deepgram batch, или
   `gpt-4o-transcribe` — последний уже есть в проекте и не требует нового вендора.
